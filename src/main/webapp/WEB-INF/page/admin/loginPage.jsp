...
<head>
    ...
    <title>schoolmall 管理后台 - 登录</title>
</head>
<body>
<div id="div_background">
    ...
    <div id="div_main">
        <div id="div_head"><p>schoolmall <span>管理后台</span></p></div>
        <div id="div_content">
    ...
    <div id="div_foot">
        <span>© 2020 XQ Team <a href="https://license.coscl.org.cn/MulanPSL/" target="_blank">Mulan PSL v1</a></span>
        <span> ⋅ </span>
