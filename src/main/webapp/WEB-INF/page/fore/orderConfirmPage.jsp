        ...
        <table class="table_order_orderItem">
            ...
            <tr>
                <td colspan="4">
                    ...
                    <span class="info_value">校园商家模拟旗舰店</span>
                </td>
            </tr>
            <tr>
                <td colspan="4">
...
<%--                    <li>请收到货后，再确认收货！否则您可能钱货两空！</li>--%>
                ...
                <script>
                    function confirmOrder() {
                        ...
                        if (yn) {
                            $.ajax({
                                url: "/schoolmall/order/success/${requestScope.productOrder.productOrder_code}",
                                type: "PUT",
                                data: null,
                                dataType: "json",
                                success: function (data) {
                                    if (data.success) {
                                        location.href = "/schoolmall/order/success/${requestScope.productOrder.productOrder_code}";
                                    } else {
                                        alert("订单确认异常，请稍后再试！");
                                        location.href = "/schoolmall/order/0/10";
                                    }
                                },
                                error: function (data) {
                                    alert("订单确认异常，请稍后再试！");
