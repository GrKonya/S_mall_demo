...
<nav>
    ...
    <div class="header">
        <a href="${pageContext.request.contextPath}"><img
                src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/schoolmallLogoB.png"></a>
        <span class="shopNameHeader">校园模拟${requestScope.product.product_category.category_name}官方旗舰店</span>
            ...
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="shopSearchInput">
                    <input type="text" class="searchInput" name="product_name" placeholder="搜索 商品/品牌/店铺"
                           maxlength="50">
                    <input type="submit" value="搜全站" class="searchschoolmall">
                </div>
    ...
    <div class="context_info">
        ...
        <div class="context_info_main">
            <div class="context_info_main_ad">
                ...
                <span>全站实物商品通用</span>
                <a href="#">去刮券<img
                        src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/schoolmallItemContentB.png"></a>
            </div>
        ...
        <ul class="context_other_panel">
            ...
            <li class="schoolmall_points">送积分<span><fmt:formatNumber type="number"
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data.success) {
                                        ...
                                        if (data.url != null) {
                                            location.href = "/schoolmall" + data.url;
                                        } else {
                                            alert("加入购物车失败，请稍后再试！");
                                        }
                                    }
                ...
                <c:forEach items="${requestScope.loveProductList}" var="product">
                    <li class="context_ul_main">
                        <div class="context_ul_img">
                            <a href="/schoolmall/product/${product.product_id}">
