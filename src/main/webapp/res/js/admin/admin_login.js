$(function () {
    ...
    $("#btn_login").click(function () {
        ...
        $.ajax({
            url: "/schoolmall/admin/login/doLogin",
            type:"post",
            ...
            success:function (data) {
                ...
                if (data.success) {
                    ...
                    location.href = "/schoolmall/admin";
                } else {
...
function initialCookie() {
    ...
    if(document.cookie.length>0) {
        ...
        if(url !== null) {
            ...
            $("#div_background").css("background-image", "url(/schoolmall/res/images/admin/loginPage/background-4.jpg)");
        }
        if(username !== null){
        ...
        $("#div_background").css("background-image", "url(/schoolmall/res/images/admin/loginPage/background-1.jpg)");
    }
}
//初始化页面数据
...
function getUserProfilePicture(username) {
    if(username !== null && username !== ""){
        $.getJSON("/schoolmall/admin/login/profile_picture",{"username":username},function (data) {
            if(data.success){
                if(data.srcString !== null){
                    $("#img_profile_picture").attr("src", "/schoolmall/res/images/item/adminProfilePicture/" + data.srcString);
                    return true;
                }
            }
        });
    }
    $("#img_profile_picture").attr("src","/schoolmall/res/images/admin/loginPage/default_profile_picture-128x128.png");
}
